  ...
  <>
   ...
   <form onSubmit={login}>
     <div className="user-box">
       <input type="email" name="email" onChange={onChangeHandler} placeholder="Enter your email" value={credentials.email} required />
       <label>Email</label>
     </div>
     <div className="user-box">
       <input type="password" name="password" onChange={onChangeHandler} placeholder="Enter your password" value={credentials.password} required />
